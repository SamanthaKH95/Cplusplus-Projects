...
private:
    ...
    LL<Working> workingMines;
    LL<Abandoned> abandonedMines;
...
public:
    ...
    unsigned long countWorking() const {return workingMines.size();}
    unsigned long countAbandoned() const {return abandonedMines.size();}
    
    virtual void displayExecReport1(std::ostream &out=cout) const;
