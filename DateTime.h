...
const int JAN_MONTH_INT = 1;
const int FEB_MONTH_INT = 2;
const int MARCH_MONTH_INT = 3;
const int APRIL_MONTH_INT = 4;
const int MAY_MONTH_INT = 5;
const int JUNE_MONTH_INT = 6;
const int JULY_MONTH_INT = 7;
const int AUGUST_MONTH_INT = 8;
const int SEPT_MONTH_INT = 9;
const int OCT_MONTH_INT = 10;
const int NOV_MONTH_INT = 11;
const int DEC_MONTH_INT = 12;

const int MAX_DAY_29 = 29;
const int MAX_DAY_30 = 30;
const int MAX_DAY_31 = 31;
